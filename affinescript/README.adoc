...
This repository is documented and distributed under MPL-2.0. The MPL-2.0 license layer on top of MPL-2.0 is the licensing for:
...
- **MPL-2.0 (MPL-2.0)**: https://github.com/hyperpolymath/palimpsest-license

**Game Content**: MPL-2.0 ensures game modifications remain open.
**Core Technology**: MPL-2.0 provides permissive licensing for tooling.
...
* https://github.com/hyperpolymath/gossamer[Gossamer - MPL-2.0]
* https://github.com/hyperpolymath/burble[Burble - MPL-2.0]
