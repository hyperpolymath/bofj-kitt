...
// Replace bofj-kitt, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= bofj-kitt — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./bofj-kitt-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/bofj-kitt/wiki
